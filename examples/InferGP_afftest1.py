...
#construct the GP
MyGP = Infer.GP(flux,np.matrix([t,]).T,p=guess_pars,mf=Transit_aRs,mf_args=t,n_hp=3)
...
n = 100
err_pars = 0.01*np.array([0.001,0.001,0.0001] + [0.00001,0,0.2,0.0003,0.02,0.0,0.0,0.001,0.0001])
Infer.AffInvMCMC(MyGP.logPosterior,MyGP._pars,(),n,chain_len/n,err_pars,n_chains=no_ch)
